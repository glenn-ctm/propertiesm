        ...
        <div class="inline-block relative w-full">
            <div class="flex flex-col items-center relative">
                <div x-on:click="open" class="w-full  ">
                    <div class="p-1 flex border border-gray-300 bg-gray-100 rounded">
                        <div class="flex flex-auto flex-wrap">
                            ...
                            <div x-show="selected.length    == 0" class="flex-1">
                                <input placeholder="Select Option/s" class="bg-transparent p-1 px-2 appearance-none outline-none h-full w-full text-gray-700 text-sm font-light" x-bind:value="selectedValues()">
                            </div>
                        </div>
                            ...
                            <template x-for="(option,index) in options" :key="option">
                                <div>
                                    <div class="cursor-pointer w-full border-gray-100 rounded-t border-b hover:bg-teal-100 text-gray-700 text-sm"
                                        ...
                                        <div x-bind:class="option.selected ? 'checked' : 'box'"
