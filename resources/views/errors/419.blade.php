...
<div id="error" class="flex justify-center items-center relative">
    <div class="absolute text-center w-100">
        ...
        <p class="error-num uppercase m-0 text-gray-500 leading-none relative z-30">419</p>
        <p class="font-bold uppercase text-blue-500 subtitle">Session Expired!</p>
        <p class="text-gray-600 tracking-wider mb-8 mt-4 text-lg md:text-xl">Sorry your session has expired, please refresh and try again.</p>
