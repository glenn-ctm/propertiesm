...
<div id="error" class="flex justify-center items-center relative">
    <div class="absolute text-center w-100">
        ...
        <p class="error-num uppercase m-0 text-gray-500 leading-none relative z-30">255</p>
        <p class="font-bold uppercase text-blue-500 subtitle">Software Error</p>
        <p class="text-gray-600 tracking-wider mb-8 mt-4 text-lg md:text-xl">An error occured in the application and the page could not be served.</p>
