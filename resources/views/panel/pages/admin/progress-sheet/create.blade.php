...
<form action="{{ route('progress-sheets.store') }}" method="POST">
    @csrf
    <!-- Header -->
                ...
                <table class="border table-auto">
                    ...
                    <tbody>
                        ...
                        <input type="hidden" name="lsAmountPerWeek"
                            value="{{ old('lsAmountPerWeek', $nProgSheet['landScaping']) }}">
                        <input type="hidden" name="sCamountPerWeek"
                            value="{{ old('sCamountPerWeek', $nProgSheet['siteCheck']) }}">
...
@push('script')
@include('panel.pages.admin.progress-sheet.scripts.create-script')
