...
<div class="px-0 lg:px-5">
    <div class="flex">
        <p class="text-3xl">Welcome to your Properties/M Dashboard, {{$name}}!</p>
    </div>
    <div class="md:flex content-center flex-wrap -mx-2 p-3 bg-grey rounded">
        <div class="md:flex w-full lg:w-1/2 xl:w-2/3 my-2 lg:my-5 lg:pr-3">
            <div class="bg-white rounded shadow-md py-8 px-10">
                ...
                <div class="mt-6">
                     <a class="transition duration-500 ease-in primary-text-color hover:text-blue-700 text-white font-medium text-lg py-2 pr-6 rounded text-sm underline cursor-pointer" href="/about-us">
                        About Us &rarr;
                    </a>
                </div>
            </div>
      ...
      <div class="md:flex w-full lg:w-1/2 xl:w-1/3 my-2 lg:my-5">
        <div class="gradient-bg rounded shadow py-10 px-10 text-white text-center">
                ...
                <div class="mt-10">
                    <a class="w-full block primary-text-color hover:text-blue-500 bg-white text-white font-bold py-3 px-6 rounded text-sm uppercase cursor-pointer shadow-md" href="{{ route('repair-requests.create') }}">
