...
<div class="flex flex-wrap">
    <div class="w-full md:w-1/2 lg:w-1/2 px-2 mb-4">
        <h1 class="text-3xl text-black">Admin Accounts</h1>
    </div>

    <div class="w-full flex md:w-1/2 lg:w-1/2 px-2 mb-4 text-right mt-5">
        <a class="mr-5 text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline" href="add">
            Add
        </a>
    ...
    <div class="shadow overflow-hidden rounded border-b border-gray-200">
        <table class="border-collapse w-full">
            <thead class="bg-gray-800 text-white">
                <tr>
                    <th class="p-3 font-bold uppercase border border-gray-300 hidden lg:table-cell">ADMIN PIN</th>
                    ...
                    <div class="overflow-hidden rounded">
                        <form class="w-full">
                            <div class="md:flex md:items-center mb-6">
                                Are you sure you want to delete AD0001?
                            </div>
