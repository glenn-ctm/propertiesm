...
@section('content')
<h1 class="text-3xl text-black px-2 mb-5">Edit Tenant</h1>
<div>
    <div class="p-7 bg-white shadow-lg">
        <form>
            ...
            <div class="w-full flex-1 m-2">
                <label class="block mt-3 text-gray-800 text-sm leading-8" for="portal-id">
                    Profile Image:
                </label>
            ...
            <div class="flex flex-col md:flex-row">
                <div class="w-full flex-1 m-2">
                    ...
                    <input id="adminID" name="adminID" type="text" placeholder="" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" value="TN-0001">
                </div>
                <div class="w-full flex-1 m-2">
                    <label for="fname" class="mt-3 text-gray-800 text-sm leading-8"> Full Name:</label>
                    <input id="fname" name="fname" type="text" placeholder="" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" value="Fionah Gill">
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row">
                <div class="w-full flex-1 m-2">
                    ...
                    <input id="adminID" name="adminID" type="email" placeholder="" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" value="tenant@email.com">
                </div>
                <div class="w-full flex-1 m-2">
            ...
            <div class="flex">
                <div class="flex-1 mx-2 my-3">
                    <label for="address" class="mt-3 text-gray-800 text-sm leading-8"> Unit:</label>
                    <input id="address" name="address" type="text" placeholder="" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" value="1">
                </div>
                <div class="flex-1 mx-2 my-3">
