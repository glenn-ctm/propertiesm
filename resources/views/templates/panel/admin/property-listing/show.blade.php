...
<div class="flex flex-wrap">
    <div class="w-full md:w-1/2 lg:w-1/2 px-2 mb-4">
        <h1 class="text-3xl text-black">Property Listing</h1>
    </div>

    <div class="flex-row sm:flex w-full sm:w-1/2 px-2 mb-4 mt-5 flex-wrap">
        <div class="w-full sm:w-3/12">
            <a class="inline-block w-full mb-2 sm:mb-0 sm:mr-5 text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline" href="add">
            Add Property
            </a>
        </div>
        <div class="w-full sm:w-9/12">
            <div class="flex shadow rounded">
                <input class="w-full p-2 ml-0 sm:ml-3 focus:outline-none" type="text" placeholder="Search by Address">
