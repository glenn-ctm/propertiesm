        ...
        <div class="flex-column lg:flex">
            <div class="w-full lg:w-1/2 mr-6">
                ...
                <div class="flex items-center mb-2">
                    <div class="flex-1 m-2">
                        ...
                        <input type="number" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" id="units" name="units">
                    </div>
                    <div class="flex-1 m-2">
                        <label class="mt-3 text-gray-800 text-sm leading-8" for="rooms">
                            Rooms:
                        </label>
                        <input type="number" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" id="rooms">
                    </div>
                </div>
                ...
                <div class="flex items-center mb-2">
                    <div class="flex-1 m-2">
                        ...
                        <input type="number" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" id="bath">
                    </div>
                    <div class="flex-1 m-2">
                        <label class="mt-3 text-gray-800 text-sm leading-8" for="sqft">
                            Square Footage:
                        </label>
                        <input type="number" class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" id="sqft">
                    </div>
                </div>

                <div class="flex flex-wrap items-center mx-2 mb-4">
                    <label class="mt-3 text-gray-800 text-sm leading-8" for="pets">Pets:</label>
                    <input class="bg-gray-100 flex border border-gray-300 rounded py-2 px-3 appearance-none outline-none w-full text-gray-800 focus:outline-none focus:shadow-outline focus:bg-white" id="pets" type="text">
                </div>
            ...
            <div class="w-full lg:w-1/2">
                <div class="border rounded border-gray-200 mx-2 px-4 pb-6 my-8">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div class="inputGroup flex-1 bg-white block my-1 mx-1 relative">
                            <input id="option1" name="option1" type="checkbox" class="h-8 w-8 order-1 cursor-pointer invisible"/>
                            <label for="option1" class="py-2 px-7 w-100 block text-left text-gray-700 cursor-pointer relative z-10 transition-11 duration-300 ease-in overflow-hidden border border-2 border-gray-300 rounded">Downstairs Unit</label>
                        </div>

                        <div class="inputGroup flex-1 bg-white block my-1 mx-1 relative">
                            <input id="option2" name="option2" type="checkbox" class="h-8 w-8 order-1 cursor-pointer invisible"/>
                            <label for="option2" class="py-2 px-7 w-100 block text-left text-gray-700 cursor-pointer relative z-10 transition-11 duration-300 ease-in overflow-hidden border border-2 border-gray-300 rounded">Upstairs Unit</label>
                        </div>

                        <div class="inputGroup flex-1 bg-white block my-1 mx-1 relative">
                            <input id="option3" name="option3" type="checkbox" class="h-8 w-8 order-1 cursor-pointer invisible"/>
                            <label for="option3" class="py-2 px-7 w-100 block text-left text-gray-700 cursor-pointer relative z-10 transition-11 duration-300 ease-in overflow-hidden border border-2 border-gray-300 rounded">Washer/Dryer Hook Up</label>
                        </div>

                        <div class="inputGroup flex-1 bg-white block my-1 mx-1 relative">
                            <input id="option4" name="option4" type="checkbox" class="h-8 w-8 order-1 cursor-pointer invisible"/>
                            <label for="option4" class="py-2 px-7 w-100 block text-left text-gray-700 cursor-pointer relative z-10 transition-11 duration-300 ease-in overflow-hidden border border-2 border-gray-300 rounded">Community Laundry</label>
                        </div>

                        <div class="inputGroup flex-1 bg-white block my-1 mx-1 relative">
                            <input id="option5" name="option5" type="checkbox" class="h-8 w-8 order-1 cursor-pointer invisible"/>
                            <label for="option5" class="py-2 px-7 w-100 block text-left text-gray-700 cursor-pointer relative z-10 transition-11 duration-300 ease-in overflow-hidden border border-2 border-gray-300 rounded">Parking Place</label>
                        </div>

                        <div class="inputGroup flex-1 bg-white block my-1 mx-1 relative">
                            <input id="option6" name="option6" type="checkbox" class="h-8 w-8 order-1 cursor-pointer invisible"/>
                            <label for="option6" class="py-2 px-7 w-100 block text-left text-gray-700 cursor-pointer relative z-10 transition-11 duration-300 ease-in overflow-hidden border border-2 border-gray-300 rounded">Exterior Storage</label>
                        </div>
                    </div>
                ...
                <div class="border rounded border-gray-200 mx-2 px-4 pb-6 mt-8">
                    ...
                    <p class="my-2 mx-1 mr-2 text-center">Section 8</p>
                    <div class="flex items-center">
                        <div class="inputGroup flex-1 bg-white block my-2 mx-1 relative">
