    ...
    <div class="flex-row sm:flex w-full sm:w-1/2 px-2 mb-4 mt-5 flex-wrap">
        ...
        <div class="w-full sm:w-9/12">
            <div class="flex shadow rounded">
                <input class="w-full p-2 ml-0 sm:ml-3 focus:outline-none" type="text" placeholder="Search...">
        ...
        <table class="border-collapse w-full">
            <thead class="bg-gray-800 text-white">
                <tr>
                    ...
                    <th class="p-3 font-bold uppercase border border-gray-300 hidden lg:table-cell">DESCRIPTION</th>
                    <th class="p-3 font-bold uppercase border border-gray-300 hidden lg:table-cell">VID/IMAGE</th>
            ...
            <tbody>
                ...
                <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                    ...
                    <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                        ...
                        <a
                            href="{{ route('vids-recs-pics.edit', $item->id) }}"
                            class="text-sm hover:text-blue-600 text-blue-800 border rounded-full bg-blue-200 border-blue-400 px-2 py-1">
                        Edit</a>
                        <a class="text-sm hover:text-green-600 text-green-800 border rounded-full bg-green-200 border-green-400 px-2 py-1" href="">View</a>
                        {{-- <form action="{{ route('vids-recs-pics.destroy', $item->id)}}" method="post">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="modal-open text-sm hover:text-red-600 text-red-800 border rounded-full bg-red-200 border-red-400 px-2 py-1">Delete</button>
                        </form> --}}
                    </td>
                </tr>
                @endforeach
                    ...
                    <div class="overflow-hidden rounded">
                        <form class="w-full">
                            <div class="md:flex md:items-center mb-10">
                                Are you sure you want to delete this vid/rec/pic?
                            </div>
                            <div class="w-full flex md:items-center">
                                <button class="mr-3 w-1/2 shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                    YES
                                </button>
