        ...
        <div class="items-center mx-2 my-4">
         ...
         <div class="w-full sm:flex sm:justify-between mt-6">
            ...
            <div class="flex justify-start mt-2 sm:mt-0">
                <a href="edit-one-time-user" class="text-center bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded focus:outline-none focus:shadow-outline">Edit</a>
