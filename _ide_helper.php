...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\AppServiceProvider::alertComponentMacros()
         * @param mixed $message
         * @param mixed $ms
         * @static 
         */ 
        public static function alertSuccess($message = '', $ms = 2000)
        {
                        return \Livewire\Component::alertSuccess($message, $ms);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function alertError($message = '', $ms = 2000)
        {
                        return \Livewire\Component::alertError($message, $ms);
        }
